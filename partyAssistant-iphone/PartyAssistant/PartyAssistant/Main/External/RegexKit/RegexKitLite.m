...
RKL_STATIC_INLINE id    rkl_CreateStringWithSubstring (id string, NSRange range)                                 { return((__bridge id)CFStringCreateWithSubstring(NULL, (__bridge CFStringRef)string, CFMakeRange((CFIndex)range.location, (CFIndex)range.length))); }
