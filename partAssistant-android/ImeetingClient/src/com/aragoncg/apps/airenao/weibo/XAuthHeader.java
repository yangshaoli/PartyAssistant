...
/**
 * Encapsulation Weibo http headers for authorizing by xauth. the order of weiboParameters will not be changed.
 * Otherwise the signature should be calculated wrong.
