...
public class CreateActivity extends Activity implements OnClickListener {
	...
	public void initRunable() {
		editSaveRun = new Runnable() {
			...
			public void run() {
				...
				params.put(Constants.DESCRIPTION, activityDescText.getText()
						.toString());
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			if (fromDetail) {
				...
				if (this.activityDes != null && !"".equals(this.activityDes)) {
					...
					this.activityDes = this.activityDescText.getText()
							.toString();
	...
	/**
	 * 
	 * Method:saveAirenaoActivity: TODO(get the Activity demo)
	 * 
	 */
		...
		myHandler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				case SUCCESS:
					...
					break;
				case FAIL:
					Toast.makeText(CreateActivity.this, "保存失败",
							Toast.LENGTH_SHORT);
					break;
				case EXCEPTION:
					Toast.makeText(CreateActivity.this, "出现异常",
							Toast.LENGTH_SHORT);
					break;
				case MSG_ID_FAIL:

					Toast.makeText(CreateActivity.this, (String) msg.getData()
							.get(MSG_ID_FAIL + ""), Toast.LENGTH_SHORT);
					break;
				case MSG_ID_SUCC:
					if (msgType.equals("SMS")) {
						Intent mIntent = new Intent(CreateActivity.this,
	...
	public void initData(Intent intent) {
		SharedPreferences mySharedPreferences = AirenaoUtills
				.getMySharedPreferences(CreateActivity.this);
		...
		if (activityDb != null) {
			...
			this.peopleLimitNum.setText(String.valueOf(activityDb
					.getPeopleLimitNum()));
		...
		if (activityFromDetail != null && fromDetail == true) {
			...
			this.peopleLimitNum.setText(String.valueOf(activityFromDetail
					.getPeopleLimitNum()));
			this.activityDescText.setText(activityFromDetail
					.getActivityContent());
		}
	...
	public void packgeDataToSendAirenaoActivity(int sendTag) {
		...
		if ("".equals(content)) {
			Toast.makeText(CreateActivity.this,
					R.string.send_lable_content_tip, Toast.LENGTH_SHORT).show();
			return;
		}
		...
		dataBundle.putString(Constants.SEND_CONTENT, activityDescText.getText()
				.toString());
