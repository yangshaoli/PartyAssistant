...
public class EditActivity extends Activity {
			...
			public void handleMessage(Message msg) {
				switch(msg.what){
				 case SUCCESS:
					 ...
					 break;
				 case FAIL:
					 Toast.makeText(EditActivity.this, "保存失败", Toast.LENGTH_SHORT);
					 break;
				 case EXCEPTION:
					 Toast.makeText(EditActivity.this, "出现异常", Toast.LENGTH_SHORT);
					 break;
				 case MSG_ID_FAIL:
					 
					 Toast.makeText(EditActivity.this, (String)msg.getData().get(MSG_ID_FAIL+""), Toast.LENGTH_SHORT);
					 break;
				 case MSG_ID_SUCC:
					 
						    Intent mIntent = new Intent(EditActivity.this,SendAirenaoActivity.class);
	...
	public void initRunable(){
		editSaveRun = new Runnable() {
			...
			public void run() {
				...
				params.put(Constants.DESCRIPTION, edtActivityDes.getText().toString());
				params.put("uID", userId);
				//myAirenaoActivity
				String result = httpHelper.performPost(url, params, EditActivity.this);
	...
	public void initDataFromOther(){
		...
		SharedPreferences mySharedPreferences = AirenaoUtills.getMySharedPreferences(EditActivity.this);
		...
		if(activityFromDetail != null && fromDetail == true){
			this.edtActivityDes.setText(activityFromDetail.getActivityContent());
		}
