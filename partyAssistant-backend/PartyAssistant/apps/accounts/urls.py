...
urlpatterns = patterns('apps.accounts.views',
    ...
    url(r'^validate_phone_bingding_ajax/(?P<key>\w+)/$', 'validate_phone_bingding_ajax', {'binding_status':'bind'}, name='validate_phone_bingding_ajax'),
    url(r'^validate_phone_unbingding_ajax/(?P<key>\w+)/$', 'validate_phone_bingding_ajax', {'binding_status':'unbind'}, name='validate_phone_unbingding_ajax'),
