...
$.extend(Datepicker.prototype, {
    ...
    _selectDate: function(id, dateStr) {
        ...
        /* 883-887 added by lihuanhuan add-date in the next text-input */
        if(inst.input.hasClass('mys')){
            if($('#id_end_date').val() == ''){
                $('#id_end_date').val(dateStr);
            }
        }
        this._updateAlternate(inst);
