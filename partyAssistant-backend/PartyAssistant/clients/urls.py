...
urlpatterns = patterns('clients.views',
    ...
    url(r'^enrolled_list/(?P<party_id>\d+)/$','apply_list',name='apply_list'),
    url(r'^norll_list/(?P<party_id>\d+)/$','notresponse_list',name='notresponse_list'),
    url(r'^reject_list/(?P<party_id>\d+)/$','notapply_list',name='notapply_list'),
